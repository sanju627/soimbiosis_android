...
public class Zombie : MonoBehaviour
{
    ...
    public void Attack()
    {
        ...
        Collider[] objCol = Physics.OverlapSphere(attackPoint.position, radius, TargetLayer);
        ...
        foreach (Collider t in banditCol)
        {
            t.GetComponent<Bandit_BP>().TakeDamage(damage);
        }
    }
